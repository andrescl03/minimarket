            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="modal fade" id="modal_service" tabindex="-1" aria-hidden="true">
                            <!--begin::Modal dialog-->
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">Registrar nuevo usuario</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center min-w-125px">Servicio</th>
...
<script>
    window.livewire.on('createServicePost', () => {
       bootstrap.Modal.getOrCreateInstance(document.querySelector('#modal_service')).hide();
    });
</script>
